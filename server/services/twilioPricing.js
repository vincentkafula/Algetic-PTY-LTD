 ...
 * reads — but this app only ever searches .local numbers (see
 * routes/numbers.js's search endpoint), so pricing is always looked up
 * as "local" to match. If that ever changes, this needs to change with it.
 */
