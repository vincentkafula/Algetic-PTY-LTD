            ...
            {slides.map((slide, i) => (
              <div key={i}>
                <div className="row align-items-center">
                  <div className={slide.image ? 'col-lg-5 col-sm-12 col-xs-12' : 'col-lg-7 col-sm-12 col-xs-12'}>
                  ...
                  {slide.image && (
                    <div className="col-lg-7 col-sm-12 col-xs-12">
                      <div style={{ borderRadius: 20, overflow: 'hidden', boxShadow: '0 24px 60px rgba(0,0,0,0.35)' }}>
                        <Image src={slide.image} alt={slide.imageAlt || ''} width={1999} height={787} sizes="(max-width: 991px) 100vw, 58vw" style={{ width: '100%', height: 'auto', display: 'block' }} priority={i === 0} />
                      </div>
                    </div>
                  )}
                </div>
