...
const STATUS_COPY = {
  pending: { title: 'Confirming your payment…', body: "This usually takes a few seconds. Don't close this page yet." },
  paid: { title: 'Payment received — finishing up…', body: 'Your order is being processed now.' },
  fulfilled: { title: 'All done!', body: 'Your order is complete.' },
  failed: { title: 'Payment did not go through', body: "You haven't been charged. You can try again from the dashboard." },
  amount_mismatch: { title: 'Something looked wrong with this payment', body: "We've flagged this for review rather than completing it automatically. Contact support with your order reference below." },
  fulfillment_failed: { title: 'Payment received, but something went wrong', body: "Your payment succeeded but we couldn't finish setting this up automatically. We've been notified and will follow up — contact support with your order reference below if you don't hear from us soon." }
};

export default function CheckoutReturnContent() {
  useRequireAuth();
  ...
  return (
    <div style={{ minHeight: '100vh', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', gap: 16, textAlign: 'center', padding: 24 }}>
      ...
      <Link href="/dashboard" className="primary" style={{ padding: '10px 20px', textDecoration: 'none', display: 'inline-block', marginTop: 8 }}>Back to dashboard</Link>
    </div>
  );
}
