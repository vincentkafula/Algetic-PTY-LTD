...
export default function WebmailLoginPage() {
  ...
  useEffect(() => {
    if (wmIsLoggedIn()) router.replace('/webmail');
  }, [router]);
      ...
      <div className="wm-form-side">
        <div className="wm-card">
          <div className="wm-logo">
            <img src="/assets/img/logo-full.png" alt="Altegic Solutions" />
          </div>
          ...
          <p className="wm-footer-line" style={{ marginTop: 24 }}>
            Don't have a mailbox yet? Ask whoever manages your Altegic account to create one, or <Link href="/login">create an Altegic account</Link>.
          </p>
        </div>
      </div>
    </div>
